...
export const metadata = { title: "Privacy — Fathom Rebuild" };

export default function Privacy() {
  return (
    <LegalPage title="Privacy" updated="26 September 2026">
      <p>Fathom Rebuild is a take-home project built for a hiring assignment. It is not a commercial service and has no customers. This page exists because Google requires one before an app can ask for calendar access, and because you deserve to know what happens to your data even in a demo.</p>
